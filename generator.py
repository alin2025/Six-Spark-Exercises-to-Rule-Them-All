...
dates = ['2022-07-01', '2022-07-02', '2022-07-03', '2022-07-04', '2022-07-05', '2022-07-06', '2022-07-07', '2022-07-08',
...
#   Generate sellers
sellers = [[0, "seller_0", 25000]]
for s in tqdm(seller_ids):
    sellers.append([s, "seller_{}".format(s), random.randint(1200, 2000)])
#   Save dataframe
...
for i in tqdm(range(0, 40)):
    ...
    for i in range(0, prod_zero):
        order_id += 1
        df_array.append([order_id, 0, 0, random.choice(dates), random.randint(1, 50), random_string(100)])
...
spark = SparkSession.builder \
    ...
    .config("spark.executor.memory", "900mb") \
    .appName("Exercise1") \
    .getOrCreate()
