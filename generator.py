...
print("Products between {} and {}".format(1, 250000))
product_ids = [x for x in range(1, 250000)]
dates = ['2022-07-01', '2022-07-02', '2022-07-03', '2022-07-04', '2022-07-05', '2022-07-06',
...
for p in tqdm(product_ids,desc = 'products Progress Bar'):
...
for s in tqdm(seller_ids,desc = 'seller_ids Progress Bar'):
    sellers.append([s, "seller_{}".format(s), random.randint(12000, 100000)])
#   Save dataframe
...
order_id = 0
for i in tqdm(range(0, 40),desc = 'sales Progress Bar'):
    df_array = []
